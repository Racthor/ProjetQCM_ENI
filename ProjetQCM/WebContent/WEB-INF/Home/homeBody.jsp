					...
					<div class="col-sm-6 col-lg-6">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="one">
								<p><img src="./assets/img/dummy1.jpg" class="pull-left" alt="" />
							...
							<div class="tab-pane" id="two">
								<p><img src="./assets/img/dummy1.jpg" class="pull-right" alt="" />
		...
		<div class="container">
				<div class="row">
								<div class="col-xs-6 col-md-2 aligncenter client">
									<img alt="logo" src="./assets/img/clients/logo1.png" class="img-responsive" />
								</div>											
													
								<div class="col-xs-6 col-md-2 aligncenter client">
									<img alt="logo" src="./assets/img/clients/logo2.png" class="img-responsive" />
								</div>											
													
								<div class="col-xs-6 col-md-2 aligncenter client">
									<img alt="logo" src="./assets/img/clients/logo3.png" class="img-responsive" />
								</div>											
													
								<div class="col-xs-6 col-md-2 aligncenter client">
									<img alt="logo" src="./assets/img/clients/logo4.png" class="img-responsive" />
								</div>									
								
								<div class="col-xs-6 col-md-2 aligncenter client">
									<img alt="logo" src="./assets/img/clients/logo5.png" class="img-responsive" />
								</div>									
								<div class="col-xs-6 col-md-2 aligncenter client">
									<img alt="logo" src="./assets/img/clients/logo6.png" class="img-responsive" />
								</div>	
